...
<body>
   <div class="card" style="border: solid 1px rgba(0, 0, 255, 0.151); width:fit-content; margin:auto; padding:20px; border-radius:20px; display:flex; flex-direction:column !important; justify-content:center;">
       <div class="card-body">
        ...
        <p class="card-text">Hello {{$userName}}.Welcome to expetr.com.Your organisation code is</p>
         <h2 class="card-title text-center" style="margin:auto; width:fit-content; background-color:#efefef; padding:10px; color:blue;">{{$content}}</h2>
          <br>
          <p>The code will be required when adding new members to {{$organisation_name}}'s account</p>
