<template>
    <div class="home mx-1">
        <!-- Modal -->
        <div
            class="modal fade conversations-modal"
            id="modelId"
            tabindex="-1"
            role="dialog"
                                    ...
                                    >
                                        ...
                                        <div class="profiles-wrapper">
                                            ...
                                            >
                                                <div class="a-wrapper">
                                                    <div
                                                        class="avatar mx-4 font-weight-bold"
                                                    >
                                                        <p class="my-3">
                                                            {{
                                                                user.name
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <div class="alert alert-danger">
                                                Not enough participants to make
                                                group
                                            </div>
                                                ...
                                                >
                                                    ...
                                                    <div class="mx-3">
                                                        <input
                                                            type="checkbox"
                                                            v-on:change="
                                                                AddParticipantConversation(
                                                                    user.id
                                                                )
                                                            "
                                                            style="background-color:blue; color:white; border-radius:50% !important;"
                                                            :name="user.name"
                                                            :value="user.id"
                                                        />
                                                    </div>
...
export default {
    ...
    methods: {
        ...
        createGroupConversation: function() {
            if (this.groupForm.participants.length < 2) {
                ...
                $(".alert-danger").hide();
                axios
                    .post(location.origin + `/api/create-group-chat`, {
        ...
        deleteConversation: function(id) {
            axios
                .post(location.origin + `/api/delete-conversation/${id}`)
                .then(() => {
        ...
        makeConversation: function(id) {
            axios
                .post(location.origin + `/api/create-private-chat/${id}`)
                .then(res => {
                    if (res.data == false) {
                        alert(
                            "you already have an ongoing conversation with this person."
                        );
                        $(".alert-success").hide();
                    } else {
                        $(".alert-success").show();
        ...
        getConversations: function() {
            axios
                .get(location.origin + "/api/getConversations")
                .then(res => {
        ...
        sendMessage: function(convId) {
            ...
            axios
                .post(location.origin + `/api/send-message/${convId}`, {
                    message: message
                })
                .then(res => {
                    if (res.data == false) {
        ...
        messagesReq: function() {
            if (this.openConversation != null) {
                axios
                    .get(
                        location.origin +
                            `/api/get-messages/${this.openConversation.conversationId}`
                    )
                    .then(res => {
                        ...
                        for (let i = 0; i < this.messages.length; i++) {
                            ...
                            axios
                                .post(
                                    location.origin +
                                        `/api/mark-message-as-read/${element.id}`
                                )
                                .then(res => {});
                        }
                        $(".loader").hide();
    ...
    mounted() {
        ...
        $(".alert-danger").hide();
        $(".alert-success").hide();
        axios.get(location.origin + `/api/user`).then(res => {
            this.me = res.data;
        });
    },
    unmounted() {
