<template>
    <nav class=" shadow-sm navbar navbar-expand-sm">
        <a class="navbar-brand"
            ><a :href="location.origin" class="logo-lg v-sm-none"
                ><img :src="'/images/logo.svg'" width="150px" alt=""/></a
            ><a :href="location.origin" class="logo-sm lg-none"
                ><img :src="'/images/favicon.svg'" alt=""/></a
            ><img
                :src="'/images/menu.svg'"
                class="logo-sm v-lg-none"
                alt=""
                        ...
                        ><a class="nav-link" href="#">
                            <div class="w">
                                <img
                                    ...
                                    alt=""
                                /><span
                                    v-if="unreadTextsCount != '0'"
                                    class="badge badge-info"
                                >
                                    {{ unreadTextsCount }}</span
                                >
                            </div>
                        </a></router-link
                    >
...
export default {
    ...
    methods: {
        ...
        countUnreadTexts: function() {
            axios
                .get(location.origin + "/api/get-unread-messages-number")
                .then(res => {
